      ...
      <div className="mx-auto max-w-[1080px]">
        <div className="mx-auto max-w-[720px] text-center">
          ...
          <p className="mt-5 text-[15px] text-muted-foreground sm:text-base md:text-lg">
            La formación completa para construir tu portafolio, a tu ritmo.
          </p>
          <p className="mt-4 text-sm text-muted-foreground">
            <span className="text-2xl font-black tracking-[-0.02em] text-foreground">$37</span>
            <span className="ml-2">· Acceso de por vida</span>
          </p>
        </div>
