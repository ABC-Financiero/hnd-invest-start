      ...
      <div className="mx-auto max-w-[1080px]">
        <div className="mx-auto max-w-[720px] text-center">
          ...
          <p className="mt-5 text-[15px] text-muted-foreground sm:text-base md:text-lg">
            Un mes de trabajo directo conmigo para diseñar tu portafolio, hacer tu primera inversión en vivo y dejarte con un plan a 12 meses. Ideal si prefieres que te acompañe paso a paso en lugar de estudiar por tu cuenta.
          </p>
        </div>
        ...
        <div className="mt-12 flex justify-center">
          <a
            ...
            className="group inline-flex items-center justify-center gap-2 rounded-full bg-primary px-7 py-3.5 text-sm font-semibold text-primary-foreground shadow-[0_10px_30px_-10px_oklch(0.78_0.16_152/0.55)] transition-all duration-200 hover:-translate-y-0.5 hover:bg-primary/90 sm:text-base"
          >
